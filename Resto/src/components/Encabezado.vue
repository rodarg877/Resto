...
<template>
  <div>
    <div class="top1">
      <ul v-if="usuario == null" class="nav justify-content-end">
        <li class="nav-item mt-2">
          <router-link to="/registro" style="font-size: 1rem" class="nav-link">Registrarse</router-link>
        </li>
        <li class="nav-item mt-2">
          <router-link to="/inicioSesion" style="font-size: 1rem" class="nav-link">Iniciar Sesion</router-link>
        </li>
      </ul>
      <ul v-else class="nav justify-content-end">
        <li class="nav-item">
          <router-link to="/carrito" class="nav-link">
            <i style="font-size: 2rem" class="bi bi-cart3">
              <span
                    ...
                    <ul class="nav sf-menu clearfix">
                      ...
                      <li class="sub-menu sub-menu-1">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li>
                            <router-link
                              :to="{ name: 'menu', params: { id: minutas } }"
                            >
                              Minutas
                            </router-link>
                          </li>
                          <li>
                            <router-link
                              :to="{ name: 'menu', params: { id: bebidas } }"
                            >
                              Bebidas
                            </router-link>
                          </li>
